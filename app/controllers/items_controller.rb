...
class ItemsController < ApplicationController
  ...
  before_filter :authenticate_user!, :except => [:set_dates, :exchange_price, :new, :create, :search_via_price_range, :search_keyword, :search_category, :autocomplete_item_city, :autocomplete_item_title]
